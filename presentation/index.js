      ...
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        <Slide transition={["zoom"]} bgColor="primary">
          <Heading size={1} fit caps lineHeight={1} textColor="secondary">
            <Text margin="10px 0 0" textColor="malibu" size={1} bold>
              Zero to Sixty with
            </Text>
            <Image src={images.webpacklogo} height="175px"/>
            <Text margin="0 0 0" textColor="malibu" size={1} bold>
             Two
            </Text>
          </Heading>
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="primary" >
          <BlockQuote>
            <Text textColor="malibu">Simple made easy</Text>
        ...
        <Slide transition={["fade"]} bgColor="primary">
          <Heading size={6} textColor="malibu" caps>Take Aways</Heading>
          <List>
